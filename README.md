...
## サンプルプログラムのバグ
- Happy miniのモデルファイルにバグがあり，LiDARのレーザ光と台車カバーが干渉するためナビゲーションに失敗します．モデルファイルを修正しましたので，リンクのファイルを元のファイル(~/airobot_ws/src/happy_mini_turtlebot3_sim/turtlebot3_gazebo/models/turtlebot3_happy_mini/model.sdf)に上書きしてからcolcon buildしてください．お手数をおかけしてすみません．
