...
draw_grid1(g, path=reconstruct_path(search, start=start, goal=goal), \
           point_to=search, start=start, goal=goal, title=title)


#draw_grid2(g, point_to=search, start=start, goal=goal, title=title)
